...
function closeAllPanels(){['drumPanel','pianoPanel','guitarPanel','bassPanel','vocalPanel','fxPanel','midiPanel','importPanel','timelinePanel','exportPanel'].forEach(id=>{let e=document.getElementById(id);if(e)e.classList.remove('show')})}
